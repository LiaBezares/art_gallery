...
struct Scene {
    ...
    void init() {
        ...
        float vertices[] = {
            // == Floor (Grease) ==
            // Posicion         // Colors
            -5.0f, -1.0f, -5.0f,   0.5f, 0.5f, 0.5f, // Left Behind
             5.0f, -1.0f, -5.0f,   0.5f, 0.5f, 0.5f, // Right Behind
             5.0f, -1.0f,  5.0f,   0.5f, 0.5f, 0.5f, // Right Front
            -5.0f, -1.0f,  5.0f,   0.5f, 0.5f, 0.5f, // Left Front

            // == Back wall (Dark blue of exhibition) ==
            -5.0f, -1.0f, -5.0f,   0.15f, 0.2f, 0.3f,
             5.0f, -1.0f, -5.0f,   0.15f, 0.2f, 0.3f,
             5.0f,  3.0f, -5.0f,   0.15f, 0.2f, 0.3f,
            -5.0f,  3.0f, -5.0f,   0.15f, 0.2f, 0.3f,

            // == Left wall (White) ==
            -5.0f, -1.0f,  5.0f,   0.75f, 0.75f, 0.7f,
            -5.0f, -1.0f, -5.0f,   0.75f, 0.75f, 0.7f,
            -5.0f,  3.0f, -5.0f,   0.75f, 0.75f, 0.7f,
            -5.0f,  3.0f,  5.0f,   0.75f, 0.75f, 0.7f,
...
int main()
{
    State state(800, 600, "3D Virtual Art Gallery - Tappa 04");
